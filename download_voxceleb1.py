...
import shutil
import sys
from utils import Pathlike, urlretrieve_progress, check_md5
...
VOXCELEB1_TRIALS_URL = [
    ["https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/veri_test2.txt", "b73110731c9223c1461fe49cb48dddfc"],
    # voxceleb1-o cleaned
    ["https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/list_test_hard2.txt", "857790e09d579a68eb2e339a090343c8"],
    # voxceleb1-h cleaned
    ["https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/list_test_all2.txt", "a53e059deb562ffcfc092bf5d90d9f3a"]
    # voxceleb1-e cleaned
]
